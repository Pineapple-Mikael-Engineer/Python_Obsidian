---
title: ax.set_xticks — Control de ticks del eje X
aliases:
  - set_xticks
  - ticks x
  - xticks
...
# ax.set_xticks — Control de ticks del eje X
...
| Método | Propósito |
|--------|-----------|
| `set_xticks` | Definir **dónde** están los ticks |
| `set_xticklabels` | Definir **qué texto** muestran (obsoleto, usar `labels` en `set_xticks`) |
| [[ax.tick_params]] | Estilo de ticks (tamaño, color, dirección) |
| [[ax.set_xlim]] | Definir límites del eje (no los ticks) |
